...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [BL] = LAYOUT_default(
    ...
    KC_VOLU, KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,             KC_Y,   KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_QUOT, KC_RBRC,
    KC_VOLD, MO(SL),  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,             KC_H,   KC_J,    KC_K,    KC_L,    KC_SCLN, KC_BSPC,          KC_ENT,
             KC_LSPO, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,             TG(GAME), KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSPC, MO(FL),
             KC_LCTL,          KC_LALT, KC_RGUI, MO(SL),                           KC_SPC,           KC_RALT,          KC_RCTL
  ),
  ...
  [GAME] = LAYOUT_default(
    ...
    KC_PGDN,  KC_LCTL, _______, _______, _______, _______, _______,              _______, _______, _______, _______, _______, _______,          _______,
  ...
  [SL] = LAYOUT_default(
    ...
    RGB_RMOD, _______, _______, _______, _______, _______, _______,          KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT, _______, S_DWORD,          _______,
              _______, _______, _______, _______, _______, _______,          _______, _______, _______, _______,  _______, _______, _______, _______,
              _______,          _______, KC_SPC, _______,                            _______,          _______,          _______
  ),
