...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [BASE] = LAYOUT(
        ...
        KC_TAB,   KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_LBRC, KC_QUOT,      KC_RBRC,
        MO(FL),      KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_BSPC,         KC_ENT,
        KC_LSPO,       KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RSPC, TG(GAME),
                    KC_LCTL, KC_LALT,                    KC_SPC,           KC_LGUI, TG(MAC)),
    ...
    [GAME] = LAYOUT(
        ...
        KC_LSFT,       _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
                    _______, KC_LALT,                    _______,           KC_LALT, _______),
    ...
    [FL] = LAYOUT(
        ...
        _______, _______, _______, _______, _______, _______, KC_PPLS, KC_PMNS, KC_END,  KC_PGDN,  KC_DOWN, _______, KC_VOLU,
        _______, _______, _______, _______, KC_VOLD),
