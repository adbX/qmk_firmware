...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BL] = LAYOUT_65_ansi(
        ...
        MO(SL),  KC_LSFT, KC_Z,    KC_X,   KC_C,    KC_V,  KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,   KC_SLSH, KC_RSFT,          KC_UP,   KC_VOLD,
        KC_LCTL, KC_LGUI, KC_LALT,                         KC_SPC,                    MO(WL),  MO(FL),   KC_NUHS, KC_LEFT,          KC_DOWN, KC_RGHT),
